...
def adam(x, dx, config=None):
    ...
    config['m'] = (1 - beta1) * dx + beta1 * config['m']
    config['v'] = (1 - beta2) * dx ** 2 + beta2 * config['v']
    config['t'] += 1

    mk = config['m'] / (1 - beta1 ** config['t'])
    vk = config['v'] / (1 - beta2 ** config['t'])

    next_x = x - lr * mk / (np.sqrt(vk) + eps)
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
